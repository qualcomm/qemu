 ...
 * have type information
 *
 * FIXME: this may be called out of the CPU context, at which point
 * what do we do when the plugin calls something we currently assume
 * can be queued to current_cpu?
 */
QEMU_DISABLE_CFI
