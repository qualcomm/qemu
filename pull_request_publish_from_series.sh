...
published_branch=$GITUSER/series/$branch_name
...
cat > changes << EOF
CI $branch:
- https://github.com/qualcomm/qemu/tree/${published_branch}-github-ci
- https://gitlab.com/p-b-o/qemu/-/tree/${published_branch}-gitlab-ci
---------------------------------
Changes:
EOF
