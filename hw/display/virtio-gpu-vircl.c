                                     ...
                                     struct virtio_gpu_ctrl_command *cmd)
{
    ...
    vircl_renderer_resource_detach_iov(unref.resource_id,
                                       &res_iovs,
                                       &num_iovs);
    if (res_iovs != NULL && num_iovs != 0) {
        virtio_gpu_cleanup_mapping_iov(g, res_iovs, num_iovs);
    }
    vircl_renderer_resource_unref(unref.resource_id);
}
                                     ...
                                     struct virtio_gpu_ctrl_command *cmd)
{
    ...
    vircl_renderer_context_create(cc.hdr.ctx_id, cc.nlen, cc.debug_name);
}
                                      ...
                                      struct virtio_gpu_ctrl_command *cmd)
{
    ...
    vircl_renderer_context_destroy(cd.hdr.ctx_id);
}
                                  ...
                                  struct virtio_gpu_ctrl_command *cmd)
{
    ...
    if (ss.resource_id && ss.r.width && ss.r.height) {
        ...
        ret = vircl_renderer_resource_get_info(ss.resource_id, &info);
#endif
        if (ret == -1) {
                                ...
                                struct virtio_gpu_ctrl_command *cmd)
{
    ...
    vircl_renderer_submit_cmd(buf, cs.hdr.ctx_id, cs.size / 4);
                                          ...
                                          struct virtio_gpu_ctrl_command *cmd)
{
    ...
    vircl_renderer_transfer_write_iov(t2d.resource_id,
                                      0,
                                      0,
                                      0,
                                      0,
                                          ...
                                          struct virtio_gpu_ctrl_command *cmd)
{
    ...
    vircl_renderer_transfer_write_iov(t3d.resource_id,
                                      t3d.hdr.ctx_id,
                                      t3d.level,
                                      t3d.stride,
                                      t3d.layer_stride,
                                ...
                                struct virtio_gpu_ctrl_command *cmd)
{
    ...
    vircl_renderer_transfer_read_iov(tf3d.resource_id,
                                     tf3d.hdr.ctx_id,
                                     tf3d.level,
                                     tf3d.stride,
                                     tf3d.layer_stride,
                                          ...
                                          struct virtio_gpu_ctrl_command *cmd)
{
    ...
    ret = vircl_renderer_resource_attach_iov(att_rb.resource_id,
                                             res_iovs, res_niov);
                                          ...
                                          struct virtio_gpu_ctrl_command *cmd)
{
    ...
    vircl_renderer_resource_detach_iov(detach_rb.resource_id,
                                       &res_iovs,
                                       &num_iovs);
    if (res_iovs == NULL || num_iovs == 0) {
        return;
                                          ...
                                          struct virtio_gpu_ctrl_command *cmd)
{
    ...
    vircl_renderer_ctx_attach_resource(att_res.hdr.ctx_id, att_res.resource_id);
}
                                          ...
                                          struct virtio_gpu_ctrl_command *cmd)
{
    ...
    vircl_renderer_ctx_detach_resource(det_res.hdr.ctx_id, det_res.resource_id);
}
                                      ...
                                      struct virtio_gpu_ctrl_command *cmd)
{
    ...
    if (info.capset_index < VIRTIO_GPU_MAX_CAPSETS) {
        ...
        vircl_renderer_get_cap_set(resp.capset_id,
                                 ...
                                 struct virtio_gpu_ctrl_command *cmd)
{
    ...
    vircl_renderer_get_cap_set(gc.capset_id, &max_ver,
                               &max_size);
    if (!max_size) {
        cmd->error = VIRTIO_GPU_RESP_ERR_INVALID_PARAMETER;
        return;
    ...
    vircl_renderer_fill_caps(gc.capset_id,
                             gc.capset_version,
                                           ...
                                           struct virtio_gpu_ctrl_command *cmd)
{
    ...
    ret = vircl_renderer_resource_create_blob(&virgl_args);
    if (ret) {
                                        ...
                                        struct virtio_gpu_ctrl_command *cmd)
{
    ...
    ret = vircl_renderer_resource_map(res->resource_id, &res->mapped, &size);
    if (ret) {
    ...
    vircl_renderer_resource_get_map_info(mblob.resource_id, &resp.map_info);
    virtio_gpu_ctrl_response(g, cmd, &resp.hdr, sizeof(resp));
}
                                    ...
                                    struct virtio_gpu_simple_resource *res)
{
    ...
    res->mapped = NULL;
    return vircl_renderer_resource_unmap(res->resource_id);
}
                                      ...
                                      struct virtio_gpu_ctrl_command *cmd)
{
    ...
    vircl_renderer_create_fence(cmd->cmd_hdr.fence_id, cmd->cmd_hdr.type);
}
...
int virtio_gpu_vircl_init(VirtIOGPU *g)
{
    ...
    ret = vircl_renderer_init(g, flags, &virtio_gpu_3d_cbs);
    if (ret != 0) {
...
int virtio_gpu_vircl_get_num_capsets(VirtIOGPU *g)
{
    ...
    vircl_renderer_get_cap_set(VIRTIO_GPU_CAPSET_VIRGL2,
                               &capset_max_ver,
                               &capset_max_size);
    if (capset_max_ver) {
    ...
    vircl_renderer_get_cap_set(VIRTIO_GPU_CAPSET_VENUS,
                               &capset_max_ver,
                               &capset_max_size);
    if (capset_max_size) {
    ...
    vircl_renderer_get_cap_set(VIRTIO_GPU_CAPSET_VCL,
                               &capset_max_ver,
                               &capset_max_size);
    if (capset_max_size) {
        gl->capset_ids[capset_count] = VIRTIO_GPU_CAPSET_VCL;
        capset_count++;
    }
