...
#define STATUS_INSTANTIATE_REQUIRED BIT(5)
#define STATUS_RESEED_REQUIRED BIT(6)
#define STATUS_GENERATE_REQUIRED BIT(7)
#define STATUS_CURRENT_OPERATION_SHIFT 8
#define STATUS_CURRENT_OPERATION_MASK (0x3 << STATUS_CURRENT_OPERATION_SHIFT)
#define STATUS_PERMANENT_FAILURE BIT(10)
