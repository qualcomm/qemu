...
/* SW_WONCE_SOC_HW_VERSION fields */
#define SW_WONCE_MINOR_VERSION_SHIFT 0
#define SW_WONCE_MINOR_VERSION_MASK  0xFF
#define SW_WONCE_MAJOR_VERSION_SHIFT 8
#define SW_WONCE_MAJOR_VERSION_MASK  0xFF
#define SW_WONCE_DEVICE_NUMBER_SHIFT 16
#define SW_WONCE_DEVICE_NUMBER_MASK  0xFFF
#define SW_WONCE_FAMILY_NUMBER_SHIFT 28
#define SW_WONCE_FAMILY_NUMBER_MASK  0xF
