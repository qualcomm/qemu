...
/*
 * CNTTID, derived on-demand: one nibble per frame, bit 0 marking the frame
 * implemented and bit 2 marking its second view present. Frames 0-7 live in
 * CNTTID_0 and frames 8-15 in CNTTID_1, so half is the index of the 8-frame
 * group to report on.
 */
