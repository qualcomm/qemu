...
/*
 * First L2VIC input line the QTimer frames are wired to: frame N drives
 * l2vic_int_src[HEX_QTIMER_L2VIC_IRQ_BASE + N].  Inputs 0 and 1 belong to
 * the SLPC wake and ISDB interrupts, and input 5 to the ETM.
 */
                                  ...
                                  const struct hexagon_machine_config *m_cfg)
{
    ...
    for (i = 0; i < HEX_QTIMER_NR_FRAMES; i++) {
