...
PrivateInclude('system/memory.h')
...
ExportedFct('libqemu_memory_region_set_fd', 'void',
        [ 'MemoryRegion *', 'int' ], iothread_locked = True)
...
ExportedFct('address_space_update_topology', 'void', [ 'AddressSpace *' ],
            priv = 'libqemu_address_space_update_topology')
...
PrivateInclude('hw/core/sysbus.h')
...
PrivateInclude('system/system.h')
...
PrivateInclude('plugins/qemu-plugin.h')
