...
#define IPCC_REG_GLOBAL_SIGNAL_STATUS_0     0x020
#define IPCC_REG_GLOBAL_SIGNAL_STATUS_1     0x024
#define IPCC_REG_GLOBAL_SIGNAL_CLEAR_0      0x028
#define IPCC_REG_GLOBAL_SIGNAL_CLEAR_1      0x02C
#define IPCC_REG_GLOBAL_SIGNAL_MASK_0       0x030
#define IPCC_REG_GLOBAL_SIGNAL_MASK_1       0x034
#define IPCC_REG_CLIENT_CLEAR               0x038
#define IPCC_REG_GLOBAL_QUAL_SIGNAL_STATUS_0 0x03C
#define IPCC_REG_GLOBAL_QUAL_SIGNAL_STATUS_1 0x040
#define IPCC_REG_SEND16                     0x044

/* Client-specific register arrays */
#define IPCC_REG_RECV_CLIENT_PRIORITY       0x100
#define IPCC_REG_RECV_CLIENT_ENABLE_0       0x200
#define IPCC_REG_RECV_CLIENT_ENABLE_1       0x300
#define IPCC_REG_RECV_CLIENT_DISABLE_0      0x400
#define IPCC_REG_RECV_CLIENT_DISABLE_1      0x500
